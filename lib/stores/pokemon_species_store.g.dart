...
mixin _$PokemonSpeciesStore on _PokemonSpeciesStoreBase, Store {
  late final _$responseAtom = Atom(
    name: '_PokemonSpeciesStoreBase.response',
    context: context,
  );
  ...
  late final _$evolutionChainResponseAtom = Atom(
    name: '_PokemonSpeciesStoreBase.evolutionChainResponse',
    context: context,
  );
  ...
  set evolutionChainResponse(RepositoriesResponse<EvolutionChainData> value) {
    _$evolutionChainResponseAtom.reportWrite(
      value,
      super.evolutionChainResponse,
      () {
  ...
  late final _$fetchSpeciesAsyncAction = AsyncAction(
    '_PokemonSpeciesStoreBase.fetchSpecies',
    context: context,
  );
